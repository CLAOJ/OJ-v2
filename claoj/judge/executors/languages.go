...
func (e *Python3Executor) Compile(ctx context.Context, source string, dir string) (*CompileResult, error) {
	// Python doesn't need compilation, just write the source
...
func (e *Python3Executor) Run(ctx context.Context, input string, limits RunLimits) (*RunResult, error) {
	// For Python, we run the interpreter with the script
...
func (e *Python3Executor) RuntimeVersions() []string {
	...
	// Version output is like "Python 3.8.10\n"
...
// NewJava11Executor creates a Java 11 executor.
func NewJava11Executor() *JavaExecutor {
	return &JavaExecutor{
		Compiler:  "javac",
		Runner:    "java",
		ClassName: "Main",
...
func (e *JavaExecutor) Run(ctx context.Context, input string, limits RunLimits) (*RunResult, error) {
	// Java needs special handling for memory limits
	return runSandboxed(ctx, e.Runner, input, limits)
}
